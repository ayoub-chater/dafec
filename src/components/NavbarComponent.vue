...
<template>
    ...
    <a href="https://themeforest.net/item/finance-financial-business-accounting-theme/16618286?ref=themesawesome">REQUEST A QUOTE</a>
    </div>
                            </div>
                        </div>
    ...
    <a href="https://financetheme.themesawesome.com/"><img src="https://d2ktnx5kgug713.cloudfront.net/wp-content/uploads/sites/20/2016/05/finance_logo.png?x12902" class="image-logo" alt="logo"></a>
    </div>
    ...
    <li id="menu-item-1934" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1934"><a href="https://financetheme.themesawesome.com/contact/">Contact</a></li>
                        ...
                        <div class="right-section col-md-2">
                            ...
                            <nav id="c-menu--slide-right" class="c-menu c-menu--slide-right">
                                ...
                                <ul id="menu-menu-1" class="sm menus"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-1592 current_page_item menu-item-1938"><a href="https://financetheme.themesawesome.com/" aria-current="page">Home</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1937"><a href="https://financetheme.themesawesome.com/about-2/">About</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1936"><a href="https://financetheme.themesawesome.com/services/">Services</a>
    <ul class="sub-menu">
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1942"><a href="https://financetheme.themesawesome.com/service/audit-assurance/">Audit &amp; Assurance</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1941"><a href="https://financetheme.themesawesome.com/service/bonds-commodities/">Bonds &amp; Commodities</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1945"><a href="https://financetheme.themesawesome.com/service/financial-projections/">Financial Projections</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1944"><a href="https://financetheme.themesawesome.com/service/strategic-planning/">Strategic Planning</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1940"><a href="https://financetheme.themesawesome.com/service/turnaround-consulting/">Turnaround Consulting</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-service menu-item-1943"><a href="https://financetheme.themesawesome.com/service/trades-stocks/">Trades &amp; Stocks</a></li>
    </ul>
    </li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1935"><a href="https://financetheme.themesawesome.com/case-studies/">Case Studies</a>
    <ul class="sub-menu">
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-project menu-item-2010"><a href="https://financetheme.themesawesome.com/case/personal-banking/">Personal Banking</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-project menu-item-2008"><a href="https://financetheme.themesawesome.com/case/plan-for-your-future/">Plan For Your Future</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-finance-project menu-item-2009"><a href="https://financetheme.themesawesome.com/case/the-next-big-thing/">The Next Big Thing</a></li>
    </ul>
    </li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1939"><a href="https://financetheme.themesawesome.com/blog/">Blog</a></li>
    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1934"><a href="https://financetheme.themesawesome.com/contact/">Contact</a></li>
    </ul>							</nav>
